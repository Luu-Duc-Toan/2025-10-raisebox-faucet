...
contract TestUnreachableDailyClaimCountReset is Test {
    ...
    function testUnreachableDailyClaimCountReset() public {
        claimUntilLimit();

        //Next day claim should be possible, but it is not due to unreachable reset logic
